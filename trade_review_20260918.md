# Trade review — 2026-09-11 to 2026-09-18
...
- Best point **+0.48R** at bar 1 (4h); worst **-0.71R** at bar 2 (8h), over 3 bar(s) so far.
...
- Best point **+0.53R** at bar 1 (4h); worst **-0.80R** at bar 2 (8h), over 3 bar(s) so far.
- Volatility **expanded ×1.27** during the trade — the market repriced rather than reverted.
...
- Best point **+0.81R** at bar 2 (8h); worst **-0.16R** at bar 1 (4h), over 2 bar(s) so far.

**Why we exited**

- Still open after 2 of 12 bars; unrealised result not scored.
