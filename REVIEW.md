...
A. EXECUTION INTEGRITY  — bugs; one occurrence is enough to act
  ...
  [OK  ] exit mix live vs expected: stop 41%/21%  time 59%/78%  target 0%/1%

B. EDGE TRACKING  — observe; act ONLY on a band breach
  closed under current rules: n=17  sumR=-9.51  mean=-0.559R
  expected +0.135R, 95% band at n~20: [-0.257, +0.527]  (cum [-5.1, +10.5]R)
  [ACT ] BELOW the 95% band — investigate before it compounds
  progress to significance: 17/169 trades (~1.1 more years at 2.56/wk)

  kill switch: trailing 50 closed trades sum < -5.0R -> take the strategy off risk
  [warm-up] 17/50 trades under current rules — not armed yet (~3.0 months to arm)
...
C. PAIR WATCH  — informational ONLY. Do not prune on these numbers.
  ...
  USD_CAD        7   -0.916  -0.017  3/6   lowest-ranked (NOT a drop signal — see note above)
  GBP_JPY        0        -  +0.077  4/6   inconsistent across years
  EUR_USD        2   -0.243  +0.126  5/6   
  AUD_USD        5   -0.346  +0.143  5/6   
...
==============================================================================
ACTION REQUIRED — 2 item(s):
  * journal rows open but closed at broker: 3 -> #55, #56, #60
